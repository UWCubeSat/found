...
struct DataFile {
     ...
     * 
     * @note This is a forwards rotation, and is generated by reference and
     * local forwards quaternions
     * 
     * @note This must be multiplied by another forwards quaternion to get
     * a meaningful orientation, the result of which is also a forwards quaternion
     */
