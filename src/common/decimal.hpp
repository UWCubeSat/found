...
#define DECIMAL_M_E2_E     (DECIMAL(0.00669437999014))                                   /* WGS84 eccentricity^2 */
#define DECIMAL_M_B_E      (DECIMAL_M_A_E * DECIMAL_SQRT(DECIMAL(1.0) - DECIMAL_M_E2_E)) /* WGS84 Semi-minor axis (m) */
