...
FOUND_CLI_OPTION("output-file"                       , std::string       , outputFile                     , ""                                                                                        , optarg                     , kNoDefaultArgument, REQ_ASSIGN, "The output file (*.found)"                                    ) \
FOUND_CLI_OPTION("camera-equatorial-coordinate-offset", found::Quaternion , cameraEquatorialCoordinateOffset, found::Quaternion(found::AngleAxis(DECIMAL_M_PI + DECIMAL_M_PI_2, found::Vec3(0, 0, 1))), found::strtoquat(optarg)   , kNoDefaultArgument, REQ_ASSIGN, "The rotation from the equatorial frame into the camera coordinate definition")
