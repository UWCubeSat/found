...
FOUND_CLI_OPTION("image-time"              , found::DateTime   , imageTime           , {}                         , found::strtodatetime(optarg), kNoDefaultArgument, REQ_ASSIGN, "Image capture time (in UT1 in format YYYY-MM-DD HH:MM:SS[.XX], XX is 0-99)" ) \
