...
FOUND_CLI_OPTION("output-file"                       , std::string       , outputFile                     , ""                                                                           , optarg                     , kNoDefaultArgument, REQ_ASSIGN, "The output file (*.found)"                                    ) \
FOUND_CLI_OPTION("camera-celestial-coordinate-offset", found::Quaternion , cameraCelestialCoordinateOffset, found::Quaternion(found::AngleAxis(DECIMAL_M_PI * 1.5, found::Vec3(0, 0, 1))), found::strtoquat(optarg)   , kNoDefaultArgument, REQ_ASSIGN, "The rotation from the celestial frame into the camera coordinate definition")
